...
public class RemindList extends BaseList {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rItem == null) {
			...
			rItem.authorView = (TextView) convertView
					.findViewById(R.id.r_author);
			rItem.remainDayView = (TextView) convertView
					.findViewById(R.id.r_remain_day);
			rItem.rCloseView = (TextView) convertView
					.findViewById(R.id.r_close);
			rItem.renewView = (TextView) convertView.findViewById(R.id.renew);
			rItem.itemMainLayout = (RelativeLayout) convertView
					.findViewById(R.id.r_item_main);
			rItem.itemBottomLayout = (LinearLayout) convertView
					.findViewById(R.id.r_item_bottom);
	...
	public String getRemainsDay(String resource) {
		...
		try {
			...
			int days = (int) Math.ceil((double) (date.getTime() - nowTime)
					/ (24 * 60 * 60 * 1000));
	...
	/**
	 * 把yyyyMMdd 转为 yyyy-MM-dd的格式 获得归还的日期
	 * 
	 * @param date
	 * @return
	 */
